...
export type Database = {
  ...
  public: {
    Tables: {
      deliveries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "deliveries_pledge_id_fkey"
            columns: ["pledge_id"]
            isOneToOne: true
      ...
      donation_needs: {
        ...
        Relationships: [
          {
            foreignKeyName: "donation_needs_ngo_id_fkey"
            columns: ["ngo_id"]
            isOneToOne: false
      ...
      ngos: {
        ...
        Relationships: [
          {
            foreignKeyName: "ngos_admin_id_fkey"
            columns: ["admin_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      pledges: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["need_id"]
            isOneToOne: false
            referencedRelation: "donation_needs"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Enums: {
      item_category: "food" | "clothing" | "medicine" | "supplies"
